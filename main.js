...
thing=quick_draw_data_set[random];
console.log(thing);
document.getElementById("drawing").innerHTML="Sketch to be drawn:" + thing;
...
function check_sketch() {
  if (thing==drawn_sketch) {
    ...
    if (timer_counter>600 || answer_holder=="set") {
      timer_counter=0;
